...
data['instock_date'] = pd.to_datetime(data['instock_date'], errors='coerce')
data.loc[:, 'year'] = data['instock_date'].dt.year
data.loc[:, 'month'] = data['instock_date'].dt.month
...
for feat in ["Stall_no","Market_Category","Loyalty_customer","Product_Category","Grade","Discount_avail",'year','month']:
...
testx=test2[["Stall_no","Market_Category","Loyalty_customer","Product_Category","Grade","Demand","Discount_avail","charges_1","charges_2 (%)","Minimum_price","Maximum_price","charges_range",'year','month']]




tx=train2[["Stall_no","Market_Category","Loyalty_customer","Product_Category","Grade","Demand","Discount_avail","charges_1","charges_2 (%)","Minimum_price","Maximum_price","charges_range",'year','month']]
...
model=ensemble.GradientBoostingRegressor(n_estimators=236,max_depth=9,min_samples_split=2,learning_rate=0.035,loss='ls')
# model=ensemble.GradientBoostingRegressor(n_estimators=200,max_depth=8,min_samples_split=2,learning_rate=0.1,loss='ls')
