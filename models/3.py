...
# test=test[test["Selling_Price"]>0]
# test=test[test["Minimum_price"]<=18000]
# test=test[test["Maximum_price"]<=28000]
...
testx=test[["Stall_no","Market_Category","Loyalty_customer","Product_Category","Grade","Demand","Discount_avail","charges_1","charges_2 (%)","Minimum_price","Maximum_price","year"]]

train=train[train["Selling_Price"]>0]
train=train[train["Minimum_price"]<=18000]
train=train[train["Maximum_price"]<=28000]
tx=train[["Stall_no","Market_Category","Loyalty_customer","Product_Category","Grade","Demand","Discount_avail","charges_1","charges_2 (%)","Minimum_price","Maximum_price","year"]]
...
#  n_jobs=-1
#  )
model=ensemble.GradientBoostingRegressor(n_estimators=400,max_depth=8,min_samples_split=2,learning_rate=0.07,loss='ls')
...
dat["Selling_Price"]=d
dat.to_csv("xg4.csv",index=False,)