...
testx=test2[["Stall_no","Market_Category","Loyalty_customer","Product_Category","Grade","Demand","Discount_avail","charges_1","charges_2 (%)","Minimum_price","Maximum_price","charges_range","charges_2 (%)cat","charges_1cat"]]




tx=train2[["Stall_no","Market_Category","Loyalty_customer","Product_Category","Grade","Demand","Discount_avail","charges_1","charges_2 (%)","Minimum_price","Maximum_price","charges_range","charges_2 (%)cat","charges_1cat"]]
...
model=ensemble.GradientBoostingRegressor(n_estimators=990,max_depth=7,min_samples_split=2,learning_rate=0.026,loss='ls')
# model=ensemble.GradientBoostingRegressor(n_estimators=990,max_depth=7,min_samples_split=2,learning_rate=0.025,loss='ls')
