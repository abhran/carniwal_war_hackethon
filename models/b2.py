...
train=train[train["Maximum_price"]<=32000]
...
model=ensemble.GradientBoostingRegressor(n_estimators=995,max_depth=7,min_samples_split=2,learning_rate=0.026,loss='ls',random_state=48)
