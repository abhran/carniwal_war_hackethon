...
data=data[["Stall_no","Market_Category","Loyalty_customer","Product_Category","Grade","Demand","Discount_avail","charges_1","charges_2 (%)","Minimum_price","Maximum_price","charges_range","Product_Category_Grade","Selling_Price"]]
import numpy as np
...
# print(data[:0])
print(data.shape)
data=pd.DataFrame(data,columns=["Stall_no","Market_Category","Loyalty_customer","Product_Category","Grade","Demand","Discount_avail","charges_1","charges_2 (%)","Minimum_price","Maximum_price","charges_range","Product_Category_Grade","Selling_Price"])
...
testx=test2[["Stall_no","Market_Category","Loyalty_customer","Product_Category","Grade","Demand","Discount_avail","charges_1","charges_2 (%)","Minimum_price","Maximum_price","charges_range","Product_Category_Grade"]]




tx=train2[["Stall_no","Market_Category","Loyalty_customer","Product_Category","Grade","Demand","Discount_avail","charges_1","charges_2 (%)","Minimum_price","Maximum_price","charges_range","Product_Category_Grade"]]
...
# model=ensemble.GradientBoostingRegressor(n_estimators=1228,max_depth=7,min_samples_split=2,learning_rate=0.02,loss='ls',random_state=48)
