...
testx=test[["Stall_no","Market_Category","Loyalty_customer","Product_Category","Grade","Demand","Discount_avail","charges_1","charges_2 (%)","Minimum_price","Maximum_price","ide","year","weekofyear","month","dayofweek","hour"]]

# testx=test[["Stall_no","Market_Category","Loyalty_customer","Product_Category","Grade","Demand","Discount_avail","charges_1","charges_2 (%)","Minimum_price","Maximum_price","year","weekofyear","month"]]
# tx=train[["Stall_no","Market_Category","Loyalty_customer","Product_Category","Grade","Demand","Discount_avail","charges_1","charges_2 (%)","Minimum_price","Maximum_price","year","weekofyear","month"]]

# testx=test[["Stall_no","Market_Category","Loyalty_customer","Product_Category","Grade","Demand","Discount_avail","charges_1","charges_2 (%)","Minimum_price","Maximum_price","year","month"]]
# tx=train[["Stall_no","Market_Category","Loyalty_customer","Product_Category","Grade","Demand","Discount_avail","charges_1","charges_2 (%)","Minimum_price","Maximum_price","year","month"]]

tx=train[["Stall_no","Market_Category","Loyalty_customer","Product_Category","Grade","Demand","Discount_avail","charges_1","charges_2 (%)","Minimum_price","Maximum_price","ide","year","weekofyear","month","dayofweek","hour"]]
...
#  n_jobs=-1
#  )
model=ensemble.GradientBoostingRegressor(n_estimators=90,max_depth=9,min_samples_split=2,learning_rate=0.09,loss='ls')
...
dat["Selling_Price"]=d
dat.to_csv("xg5.csv",index=False,)