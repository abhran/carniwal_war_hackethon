...
#  n_jobs=-1
#  )
# model=ensemble.GradientBoostingRegressor(n_estimators=250,max_depth=8,min_samples_split=2,learning_rate=0.1,loss='ls')
model=ensemble.GradientBoostingRegressor(n_estimators=255,max_depth=5,min_samples_split=2,learning_rate=0.05,loss='ls')
