...
x_train, x_test, y_train, y_test=tx.values,tx.values,ty.values,ty.values
...
model = xgb.XGBRegressor(max_depth=9,n_estimators=155, learning_rate=0.10, booster='gbtree')
# model= xgb.XGBClassifier(
#  n_jobs=-1
#  )
model=ensemble.GradientBoostingRegressor(n_estimators=90,max_depth=9,min_samples_split=2,learning_rate=0.1,loss='ls')
